...
mock_follows = [
    ...
    },
    {
        ...
        "face": "",
        "mtime": 1712345678,
        "official_verify": {"type": 1, "desc": "bilibili 2023百大UP主"},
        "vip": {"vipStatus": 1, "vipType": 2},
    },
    {
        "mid": 3,
        "uname": "JohnDoe",
        "sign": "I make videos about tech",
        "face": "",
        "mtime": 1712345678,
        "official_verify": {"type": 0, "desc": ""},
        "vip": {"vipStatus": 1, "vipType": 2},
...
assert verdicts[3]["verdict"] == "delete", (
    f"免费领取营销号应为 delete, 实际 {verdicts[3]['verdict']}"
)
